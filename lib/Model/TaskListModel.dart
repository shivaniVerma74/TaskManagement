class TaskListModel {
  ...
  TaskListModel({this.error, this.message, this.totalTasks, this.data});
  ...
  TaskListModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <TaskData>[];
      json['data'].forEach((v) { data!.add(new TaskData.fromJson(v)); });
    }
  }
...
class Comments {
  ...
  Comments({this.id, this.workspaceId, this.projectId, this.taskId, this.userId, this.comment, this.dateCreated, this.isRead});
