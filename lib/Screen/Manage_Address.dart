  ...
  void addAddressModel() {
    for (int i = 0; i < addressList.length; i++) {
      addModel.add(RadioModel(
          ...
          add:
              "${addressList[i].address.toString()}, ${addressList[i].area.toString()}, ${addressList[i].city.toString()}, ${addressList[i].state.toString()}, ${addressList[i].country.toString()}, ${addressList[i].pincode.toString()}",
